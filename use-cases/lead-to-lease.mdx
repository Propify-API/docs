---
title: "Lead to Lease"
description: "Suggest compatible units to prospective residents"
---
...
**2. Read amenities from Propify API**
```bash Request amenities
curl --request GET \
...
```json Sample amenities response payload
{
  "meta": {
    "offset": 0,
    "limit": 0,
...
```json Sample units response payload
{
  "meta": {
    "offset": 0,
    "limit": 0,
